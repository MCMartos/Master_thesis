...
python3 meta_art.py -g $(echo ${SIM_FILE}/*) -n $(wc -l ${SIM_FILE}/*) -ss MSv1 -o ${OUT}/ART_SIMULATION/ART_FILES/$(basename ${ABUNDANCE%.*}) -p -na -r ${READS} -m 152 -s 10 -l 150 -a ${ABUNDANCE}
...
do
	python3 multifasta_converter.py -N 150 -o ${PWD}/ISS_SIMULATION/MIXED_FASTA/$(basename ${SIM_FILE}) -f ${FILE}
done
...
RUN_ISS=${OUT}/ISS_SIMULATION/ISS_FILES/${NAME}_R1.fq
##Call trimmomatic
